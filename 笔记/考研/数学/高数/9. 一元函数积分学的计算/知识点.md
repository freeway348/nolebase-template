...
>2. $\Gamma(\alpha+1)=\alpha\Gamma(\alpha)=\int_0^{\infty}x^{\alpha}e^{-x}\;dx\overset{x=t^2}{=}2\int_0^{+\infty}t^{2\alpha+1}e^{-t^2}\;dt\;(x,t>0)(\alpha - 1>0)$
>3. 递推式：$\Gamma (\alpha + 1)=\int_0^{+\infty}x^{\alpha}e^{-x}\;dx=-\int_0^{+\infty}x^{\alpha}\;d(e^{-x})=-x^{\alpha}e^{-x}|_0^{+\infty}+\int_0^{+\infty}e^{-x}\alpha x^{\alpha - 1}\;dx = \alpha\Gamma (\alpha)$
>4. 其中 $\Gamma (1)=1,\Gamma(\frac{1}{2})=\sqrt{\pi}$，故 $\Gamma (n+1)=n!,\Gamma (2)=1,\Gamma (\frac{5}{2})=\frac{3}{2}\cdot\frac{1}{2}\cdot\Gamma (\frac{1}{2})=\frac{3}{4}\sqrt{\pi}$
